...
import PresentationInformation from "./Landingpres.vue";
    ...
    >
      <div class="container">
          <div class="col-lg-7 text-center mx-auto position-relative">
            <h1 
            class="display-6 text-white mt-6" 
            >
              La Société CANALO est spécialisée dans le loisir nautique : enseignement de la pêche, pour tout public et sur différents types de supports.
Nos partenaires peuvent également vous permettre d'agrémenter vos séjours par des dégustations et des visites guidées.
          </h1>
          </div>
      </div>
    </div>
